...
namespace Pbl3.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequestDto request)
        {
            ...
            var isLegacyPlainTextPassword = verificationResult == PasswordVerificationResult.Failed
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequestDto request)
        {
            ...
            var passengerRole = await _context.Roles.FirstOrDefaultAsync(r => r.RoleName == UserRole.Passenger.ToString());
        ...
        private AuthResponseDto CreateAuthResponse(User user)
        {
            if (user.Role == null)
            {
                throw new InvalidOperationException("User role is required to generate an authentication response.");
            }
